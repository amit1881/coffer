...
public class ElectricityFragment extends Fragment implements View.OnClickListener {
            ...
            case R.id.btn_recharge_now:
                ...
                if (isValidate()) {
                    if (Utility.isOnline(getActivity())) {
                        ...
                        electricityNumber = et_electricity_number.getText().toString();
    ...
    private class RechargeAsync extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            if (clientID.equals("")) {
                ...
                String url = Keys.ELECTRICITY_BILL + Keys.API_KEY + "&number=" + electricityNumber + "&provider_id=" + strProvider + "&amount="
    ...
    private boolean isValidate() {
        ...
        if (et_electricity_number.getText().toString().length() == 0) {
            Toast.makeText(getActivity(), "Please enter Electricity number!", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void SetDataOnSpinner() {
        ...
        providerList = mSqliteDb.getALLProvider(Keys.ELECTRICITY);
